...
namespace p10::infer {
inline P10Result<Dtype> ort_to_p10_dtype(ONNXTensorElementDataType ort_dtype) {
    switch (ort_dtype) {
...
inline ONNXTensorElementDataType dtype_to_ort(Dtype dtype) {
    switch (dtype) {
        ...
        default:
            (P10Error::InvalidArgument << "Unsupported P10 data type").expect("Error");
    }
